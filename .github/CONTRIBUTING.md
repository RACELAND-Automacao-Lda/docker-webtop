...
Instead edit the [readme-vars.yml](https://github.com/linuxserver/docker-webtop/edit/alpine-awesome/readme-vars.yml).
...
If you are modifying the Dockerfiles or any of the startup scripts in [root](https://github.com/linuxserver/docker-webtop/tree/alpine-awesome/root), add an entry to the changelog
